...
/***/ function(module, exports, __webpack_require__) {
	...
	var TreeView = function (_React$Component) {
	  ...
	  function TreeView(props) {
	    ...
	    _this2.setNodeId({ nodes: _this2.state.data });
	  ...
	  _createClass(TreeView, [{
	    ...
	    value: function nodeSelected(nodeId, selected) {
	      ...
	      if (selected) this.setParentSelectable(node);else this.checkParentEmpty(node);

	      this.setChildrenState(node.nodes, selected);
	      this.setState({ data: this.props.data });

	      if (this.props.onClick) this.props.onClick(this.props.data, node);
	    }
	  }, {
	    key: "nodeDoubleClicked",
	    value: function nodeDoubleClicked(nodeId, selected) {
	      var node = this.findNodeById(this.props.data, nodeId);
	      if (this.props.onDoubleClick) this.props.onDoubleClick(this.props.data, node);
	    }
	  }, {
	    key: "render",
	...
	var TreeNode = function (_React$Component2) {
	  ...
	  function TreeNode(props) {
	    ...
	    var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(TreeNode).call(this, props));
	  ...
	  _createClass(TreeNode, [{
	    ...
	    value: function render() {
	      ...
	      var nodeIcon = _react2.default.createElement(
	        "span",
	        { className: 'icon', style: treeviewSpanIconStyle },
	        " ",
	        _react2.default.createElement(
	          "i",
